...
public class ClassCSS {
    ...
    private By categoriesLocator = By.cssSelector(".col-lg-5 > div:nth-child(1) > div:nth-child(3) > button:nth-child(1)");
    private By eventsLocator = By.cssSelector("li.dropdown-submenu:nth-child(3)");
    private By eventsNameLocator = By.cssSelector("li.dropdown-submenu:nth-child(3) > a:nth-child(1)");
    private By gamePlaceFilterLocator = By.cssSelector("li.dropdown-submenu:nth-child(3) > ul:nth-child(2) > li:nth-child(1)");
    private By festivalPlaceFilterLocator = By.cssSelector("li.dropdown-submenu:nth-child(3) > ul:nth-child(2) > li:nth-child(2)");
    private By meetingPlaceFilterLocator = By.cssSelector("li.dropdown-submenu:nth-child(3) > ul:nth-child(2) > li:nth-child(3)");
    private By gamePlaceFilterNameLocator = By.cssSelector("li.dropdown-submenu:nth-child(3) > ul:nth-child(2) > li:nth-child(1) > a:nth-child(1)");
    private By festivalPlaceFilterNameLocator = By.cssSelector("li.dropdown-submenu:nth-child(3) > ul:nth-child(2) > li:nth-child(2) > a:nth-child(1)");
    private By meetingPlaceFilterNameLocator = By.cssSelector("li.dropdown-submenu:nth-child(3) > ul:nth-child(2) > li:nth-child(3) > a:nth-child(1)");
