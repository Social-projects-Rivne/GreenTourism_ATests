...
public class ClassRelativeXPath {
    ...
    private By categoriesLocator = By.xpath("//body//div[1]/div[2]/div/div[3]");
    private By eventsLocator = By.xpath("//body//div/div[3]/ul/li[3]");
    private By eventsNameLocator = By.xpath("//body//div[3]/ul/li[3]/a");
    private By gamePlaceFilterLocator = By.xpath("//body//div/div[5]/ul/li[1]");
    private By festivalPlaceFilterLocator = By.xpath("//body//li[3]/ul/li[2]");
    private By meetingPlaceFilterLocator = By.xpath("//body//li[3]/ul/li[3]");
    private By gamePlaceFilterNameLocator = By.xpath("//body//li[3]/ul/li[1]/a");
    private By festivalPlaceFilterNameLocator = By.xpath("//body//li[3]/ul/li[2]/a");
    private By meetingPlaceFilterNameLocator = By.xpath("//body//li[3]/ul/li[3]/a");
