...
public class PossibilityChangeMapTypeChromePC {
	...
	public void before(){		
        ...
        WebElement emailField = wait.until(ExpectedConditions.visibilityOfElementLocated
                (By.xpath("/html/body/header/nav/div/div[2]/ul[1]/li/ul/"
                		+ "auth/div[2]/div/form/div[1]/input")));
        emailField.sendKeys(USER_MAIL);
        
        WebElement passwordField = wait.until(ExpectedConditions.visibilityOfElementLocated
                (By.xpath("/html/body/header/nav/div/div[2]/ul[1]/li/ul/"
                		+ "auth/div[2]/div/form/div[2]/input")));
        passwordField.sendKeys(USER_PASSWORD);
        
        WebElement loginButton = wait.until(ExpectedConditions.visibilityOfElementLocated
                (By.cssSelector("html.ng-scope body header nav.navbar.navbar-default.navbar-"
        ...
        WebElement menuItemMap = wait.until(ExpectedConditions.visibilityOfElementLocated
                (By.linkText("Map")));
        menuItemMap.click(); 
	...
	public void checkPossibilityViewMapTypeButton(){
		WebElement mapTypeButton = wait.until(ExpectedConditions.visibilityOfElementLocated 
				                            (By.xpath("//button[@type='button' and contains"
				                            		+ "(., 'Map Type')]")));
